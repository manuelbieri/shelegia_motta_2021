...
setup(
    ...
    version='1.0.4',  # change with new version
    license='MIT',
    ...
    download_url='https://github.com/manuelbieri/Shelegia_Motta_2021/archive/refs/tags/v1.0.4.tar.gz',  # change with new version
    ...
    install_requires=[
        "matplotlib>=3.10.1",  # change with new version
    ],
)
