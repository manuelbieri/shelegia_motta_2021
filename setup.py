...
setup(
    ...
    version='1.0.2',  # change with new version
    license='MIT',
    ...
    download_url='https://github.com/manuelbieri/Shelegia_Motta_2021/archive/refs/tags/v1.0.2.tar.gz',  # change with new version
